...
async def start_BLaZe():
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
    ...
    if twelv:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
    ...
    if forte:
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
    ...
    if fifth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tsixx:
        ...
        try:
            ...
            await alz(functions.channels.JoinChannelRequest(channel="@BLAZE_ZONE"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
async def repo(e):
    if e.sender_id in SMEX_USERS:
       text = f"[𝗥𝗘𝗣𝗢☺](https://github.com/TEAM-BLAZ/BLAZE-SPAMMER-ROBOT)"
    await e.reply(text, parse_mode=None, link_preview=None )
