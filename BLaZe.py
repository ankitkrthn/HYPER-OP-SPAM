...
async def start_BLaZe():
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await edk(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await vkk(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await kkk(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await lkk(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await mkk(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await sid(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await shy(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
           ...
           bawait aan(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await aan(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await ake(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await eel(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await khu(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await shi(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await yaa(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await dav(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await raj(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@AleXElite_Support"))
            await put(functions.channels.JoinChannelRequest(channel="@Alex_Elite"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🔰【★ ꪖꪶꫀ᥊★】✘ sρꪖꪑꪑε𝚁 \n\n╰•★★  ℘ơŋɠ ★★•╯\n╔═╗╔═╗╔═╦╗╔══╗\n║╬║║║║║║║║║╔═╣\n║╔╝║║║║║║║║╚╗║\n╚╝─╚═╝╚╩═╝╚══╝\n`{ms}` 𝗺𝘀")
...
print(text)
print("")
print("✘𓆩ꪖꪶꫀ᥊ sρꪖꪑꪑε𝚁 ʀꪮʙʙꪮᴛ 𝑆T𝔞R𝔱є∂ sU𝐂𝐂εS𝔣𝔲𝔩𝔩Y.")
