...
from Config import STRING, SUDO, BIO_MESSAGE, ALIVE_NAME, USERNAME, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, STRING11, STRING12 , STRING13 , STRING14 , STRING15 ,STRING16 , STRING17 , STRING18 , STRING19 , STRING20 , STRING21 , STRING22 , STRING23 , STRING24 , STRING25 , STRING26 
import asyncio
...
async def start_BLaZe():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await edk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await vkk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await kkk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await lkk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await mkk(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await sid(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await shy(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await ake(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await eel(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await khu(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await shi(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await yaa(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await dav(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await raj(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await put(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tsixx:
        ...
        try:
            ...
            await alz.start()
            botme = await put.get_me()
            await alz(functions.channels.JoinChannelRequest(channel="@BLAZE_SPAMMER"))
            await alz(functions.channels.JoinChannelRequest(channel="@THE_BLAZE_NETWORK"))           
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
